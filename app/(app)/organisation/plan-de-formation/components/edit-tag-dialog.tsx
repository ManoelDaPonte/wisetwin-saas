...
import { UpdateTrainingTagData } from "@/types/training";
...
export function EditTagDialog({ tag, onEditTag, onClose, isUpdating, updateError }: EditTagDialogProps) {
  ...
  useEffect(() => {
    if (tag) {
      form.reset({
        ...
        dueDate: tag.dueDate ? format(new Date(tag.dueDate), 'yyyy-MM-dd') : "",
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Formation nouveaux employés" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Choisissez une couleur pour identifier visuellement ce plan
                  </FormDescription>
                  <FormControl>
            ...
            <div className="space-y-4 pt-4 border-t">
              <div className="flex items-center gap-2">
                ...
                <h4 className="text-sm font-medium">Configuration du plan de formation</h4>
              </div>
              ...
              <FormDescription className="text-xs">
                ...
                La date limite et la priorité s'appliquent à toutes les formations assignées à ce plan
              </FormDescription>
            </div>
