...
export default function WisetourBuildPage({
  params: routeParams,
}: {
  ...
  const { data: buildsData, isLoading, error } = useBuilds("wisetour");
    ...
    return (
      <div className="container mx-auto py-8">
        <Alert variant="destructive">
          <AlertDescription>
            Erreur lors du chargement des données de la visite: {error.message}
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  if (!build) {
    return (
      <div className="container mx-auto py-8 text-center">
        <Alert>
          <AlertDescription>Visite virtuelle non trouvée.</AlertDescription>
        </Alert>
        <Button variant="outline" asChild className="mt-4">
          <Link href="/wisetour">
            <ArrowLeft className="mr-2 h-4 w-4" /> Retour à Wisetour
          </Link>
        </Button>
      </div>
    );
    ...
    <div className="container mx-auto py-8 space-y-6">
      ...
      <Card>
          ...
          <div className="flex flex-col md:flex-row md:items-start md:gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {/* For Wisetour, difficulty/duration might be less relevant, adjust as needed */}
                {build.difficulty && (
        ...
        <CardContent className="space-y-6">
          {/* Wisetour might not have 'modules' in the same way Wisetrainer does. 
              Adjust this section if the structure of enriched data for Wisetour is different.
              For now, assuming it might have similar module/step structures if applicable.
           */}
          {build.modules && build.modules.length > 0 && (
            <div>
              <h2 className="text-2xl font-semibold mb-3">Sections / Étapes</h2>
