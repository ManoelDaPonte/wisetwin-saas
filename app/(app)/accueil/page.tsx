    ...
    <div className="container mx-auto py-8 space-y-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground">
          Bienvenue sur WiseTwin, votre plateforme de formation et de gestion d’environnements 3D
        </p>
      </div>
          ...
          <CardHeader>
            ...
            <CardDescription>
              {isPersonalSpace 
                ...
                : `Gérez ${activeOrganization?.name || 'votre organisation'}`
              }
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            {isPersonalSpace ? (
              ...
              <>
                ...
                <Button 
                  className="w-full justify-between"
                  onClick={() => router.push('/organisation/tableau-de-bord')}
                >
                  <span className="flex items-center gap-2">
