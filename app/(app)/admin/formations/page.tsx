...
export default function AdminFormationsPage() {
  ...
  const [selectedFormation, setSelectedFormation] = useState<AdminFormation | null>(null);
  ...
  const columns: AdminTableColumn<AdminFormation>[] = [
    ...
    },
    {
      ...
      label: "Type",
      render: (formation) => (
        <Badge variant={formation.buildType === "wisetrainer" ? "default" : "secondary"}>
          {formation.buildType}
        </Badge>
      ),
    },
    {
      ...
      render: (formation) => (
        <code className="text-xs bg-muted px-2 py-1 rounded">
          {formation.containerId.length > 20 
            ? `${formation.containerId.substring(0, 12)}...`
    ...
    },
    {
      ...
      label: "Métadonnées",
      render: (formation) => (
        <Badge variant={formation.hasMetadata ? "default" : "destructive"}>
