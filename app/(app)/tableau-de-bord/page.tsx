...
export default function DashboardPage() {
  ...
  const { certifications, isLoading: isCertificationsLoading } =
      ...
      <Card>
        ...
        <CardContent>
          {isActivitiesLoading ? (
            ...
            recentActivitiesWithDetails.length > 0 ? (
            <div className="space-y-4">
              {recentActivitiesWithDetails.slice(0, 3).map((activity) => (
                <div
                  key={activity.id}
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm">
                      {t.dashboard.recentActivity.you}{" "}
                      {t.dashboard.recentActivity.completed}{" "}
          ...
          {isCertificationsLoading ? (
            ...
            <div className="space-y-4">
              {certifications.slice(0, 3).map((cert) => (
                <div
                  key={cert.build.id || cert.build.name}
                  className="flex items-center gap-4 p-4 border rounded-lg"
                >
                  <div className="p-2 rounded-full bg-muted">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {format(new Date(cert.completedAt), "d MMMM yyyy", {
                        locale: fr,
                      })}
                    </p>
                  </div>
